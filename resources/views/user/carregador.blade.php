...
<body>
    ...
    <main>
        <div class="container">
            <div class="product-image">
                <img src="./imagens/carregador.png" alt="Produto">
                <p style="text-align:center;">Cores disponíveis</p>
            ...
            <div class="product-info">
                ...
                <p class="price"><strong>Ou em até 10x de R$29,90/mês</strong></p>
    ...
    <script>
        document.getElementById("carrinho").addEventListener("click", function() {
            window.location.href = "/carrinhoCarre-user"; // Redireciona para o checkout
        });
