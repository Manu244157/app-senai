    ...
    <main>
        <div class="container">
            <div class="product-image">
                <img src="./imagens/mali.png" alt="Produto">
            ...
            <div class="product-info">
                ...
                <p class="price"><strong>Ou em até 10x de R$89,90/mês</strong></p>
...
document.getElementById("carrinho").addEventListener("click", function() {
        window.location.href = "/carrinhoMali-user"; // Redireciona para o checkout
    });
