...
<body>
    <div class="header">
        ...
        <div><strong>Mali orgânica</strong></div>
        <nav>
            <ul>
    ...
    <div class="container">
        ...
        <table class="product-table">
            ...
            <tr>
                <td>
                    <img src="./imagens/carregador.png" alt="carregador" class="product-image"> Carregador
        ...
        <div id="total" class="total">Total: R$290,90</div>
